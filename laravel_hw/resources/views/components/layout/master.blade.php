...
<link href="{{asset('backend')}}/assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN PAGE STYLES -->
<link href="{{asset('backend')}}/assets/admin/pages/css/tasks.css" rel="stylesheet" type="text/css"/>
<!-- END PAGE STYLES -->
<!-- BEGIN THEME STYLES -->
...
<link href="{{asset('backend')}}/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<script src="{{asset('backend')}}/assets/global/plugins/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
...
<script src="{{asset('backend')}}/assets/global/plugins/jquery.pulsate.min.js" type="text/javascript"></script>
<script src="{{asset('backend')}}/assets/global/plugins/bootstrap-daterangepicker/moment.min.js" type="text/javascript"></script>
<script src="{{asset('backend')}}/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
...
<script src="{{asset('backend')}}/assets/admin/layout/scripts/quick-sidebar.js" type="text/javascript"></script>
<script src="{{asset('backend')}}/assets/admin/layout/scripts/demo.js" type="text/javascript"></script>
<script src="{{asset('backend')}}/assets/admin/pages/scripts/index.js" type="text/javascript"></script>
<script src="{{asset('backend')}}/assets/admin/pages/scripts/tasks.js" type="text/javascript"></script>
