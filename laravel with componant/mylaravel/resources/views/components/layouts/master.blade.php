...
<head>
    ...
    <link href="{{asset('ui/backend/admin')}}/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="{{asset('ui/backend/admin')}}/js/sb-admin-2.min.js"></script>
    ...
    <script src="{{asset('ui/backend/admin')}}/js/demo/chart-pie-demo.js"></script>
